...
2️⃣ Дай мне доступ на редактирование \(почта: *personal\.fin\.tracker\@gmail\.com*\) ✍️\n \
...
NO_ACCESS_LINK = (
    ...
    "Проверь, дал ли ты мне **доступ на редактирование** \(почта: *personal\.fin\.tracker\@gmail\.com*\) ✍️\n"
